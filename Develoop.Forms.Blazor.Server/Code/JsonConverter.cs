...
namespace Develoop.Forms.Blazor.Server.Code
{
    public class XpoModelJsonConverter<T> : JsonConverter<T> where T : PersistentBase
    {
        readonly XPDictionary dictionary;
        public XpoModelJsonConverter(XPDictionary dictionary) { this.dictionary = dictionary; }
    ...
    {
        readonly XPDictionary dictionary;
        public XpoModelJsonConverterFactory(XPDictionary dictionary) { this.dictionary = dictionary; }
