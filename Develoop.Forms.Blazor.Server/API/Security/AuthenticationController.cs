...
namespace Develoop.Forms.Blazor.Server.API.Security;
...
public class AuthenticationController : ControllerBase
{
        ...
        AuthenticationStandardLogonParameters logonParameters)
    {
        try
        {
            var result = tokenProvider.Authenticate(logonParameters);
            var response = new { AccessToken = tokenProvider.Authenticate(logonParameters) };
